...
class CommunDetail extends StatefulWidget {
  Commun commun;
  CommunDetail({required this.commun});

  @override
  _CommunDetailState createState() => _CommunDetailState();
}

class _CommunDetailState extends State<CommunDetail> {
  @override
